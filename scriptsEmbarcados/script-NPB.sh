...
BASE_DIR="$HOME/NPB-CPP"
runs=5
threads=(1, 2, 3)

rm -rf "$BASE_DIR/TESTES-NPB"
mkdir -p "$BASE_DIR/TESTES-NPB"

output_file="$BASE_DIR/TESTES-NPB/benchmark_times.txt"

> "$output_file"

for platform in "${platforms[@]}"; do
    platform_result_dir="$BASE_DIR/TESTES-NPB/result$platform"
